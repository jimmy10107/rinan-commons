...
export const metadata:Metadata={title:'植物近觀室',description:'從芋葉的細脈到稻穗的低垂，近看木麻黃、水稻、芋頭、臺灣欒樹、甜根子草與構樹的三維模型，探索生長與季節變化。',alternates:{canonical:'https://jimmy10107.github.io/rinan-commons/plants/'},openGraph:{title:'植物近觀室｜日南稻站',description:'把腳步放慢，近看一片葉、一束穗。',images:[{url:'https://jimmy10107.github.io/rinan-commons/plants/previews/taro-960.webp',width:960,height:960,alt:'芋頭三維模型的葉面特寫'}]}};
export default function PlantsPage(){return <div className="commons-site plants-page" id="top">
  <SiteHeader active="plants"/>
  <main id="content">
    <div className="plant-intro"><div><p className="kicker">RINAN BOTANICAL STUDIES / 06</p><h1>植物近觀室</h1></div><p>把腳步放慢，近看一片葉、一束穗。<br/>從田間到路旁，認識植物不同時候的樣子。</p></div>
    <PlantExplorer/>
