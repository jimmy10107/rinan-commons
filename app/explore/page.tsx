...
export default function ExplorePage(){return <main className="commons-page cis-theme map-page" id="top"><SiteHeader active="explore"/><section className="editorial-section rinan-map-section" id="content"><MapExplorer primary/><p className="source-note">里界與統計沿用提供的 2021 年地圖資料。</p><Link className="solid-link" href={'/visit/'}>到訪導航與交通方式 →</Link></section><SiteFooter note="從九里，看日南。"/></main>;}
