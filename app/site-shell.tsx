...
const navigation = [
  ...
  ['exhibition','往・返展覽','/exhibition/to-and-from/'], ['walk','走傱日南 2026','/walk/2026/'], ['explore','九里互動地圖','/explore/'], ['plants','植物近觀室','/plants/'], ['visit','到訪交通','/visit/'],
] as const;
...
export function SiteFooter({ note }: { note: string }) {
  return <footer className="commons-footer"><div className="footer-top"><a href={sitePath('/')}><strong>日南稻站</strong><span>RINAN COMMONS</span></a><p>{note}</p><a href="#top" className="to-top">回到頁首 ↑</a></div><div className="footer-bottom"><p>{site.address}<br />{site.opening}</p><nav aria-label="頁尾導覽"><a href={sitePath('/about/')}>關於稻站</a><a href={sitePath('/explore/')}>九里互動地圖</a><a href={sitePath('/plants/')}>植物近觀室</a><a href={sitePath('/visit/')}>到訪交通</a><a href={sitePath('/exhibition/to-and-from/')}>展覽手冊</a></nav><small>© {new Date().getFullYear()} 日南稻站 Rinan Commons</small></div></footer>;
}
